-- Update products with real uploaded images from Supabase Storage
UPDATE products 
...
-- For the AI translate earphones, we'll need to find/upload appropriate images
-- Temporarily using a generic earphone image
UPDATE products 
