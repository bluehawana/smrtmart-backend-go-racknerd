-- MySQL version - Update product images to use Cloudflare R2 URLs
-- Using R2 public domain: https://d10qehs4k3bdf9.cloudfront.net
...
UPDATE products SET images = JSON_ARRAY('https://d10qehs4k3bdf9.cloudfront.net/huawei-gt2-pro.jpg')
WHERE name LIKE '%Huawei%' AND name LIKE '%Watch%';

-- iPhone 16 Pro Max Case
UPDATE products SET images = JSON_ARRAY('https://d10qehs4k3bdf9.cloudfront.net/iphone16-promax-case.jpg')
...
UPDATE products SET images = JSON_ARRAY('https://d10qehs4k3bdf9.cloudfront.net/macbookair-adaptor-cable.png')
